...
BOX_LENGTH EQU 1 + MONS_PER_BOX + 1 + (BOXMON_STRUCT_LENGTH + NAME_LENGTH + MON_NAME_LENGTH) * MONS_PER_BOX + 2 // 0x450
NUM_BOXES EQU 14
NUM_BOXES_JAPANESE EQU 9

// hall of fame
// hof_mon: species, id, dvs, level, nicknames
HOF_MON_LENGTH EQU 1 + 2 + 2 + 1 + (MON_NAME_LENGTH - 1) // 0x10
// hall_of_fame: win count, party, terminator
HOF_LENGTH EQU 1 + HOF_MON_LENGTH * PARTY_LENGTH + 1 // 0x62
...
// PP
PP_UP_MASK EQU 0b11000000
PP_UP_ONE  EQU 0b01000000
PP_MASK    EQU 0b00111111
