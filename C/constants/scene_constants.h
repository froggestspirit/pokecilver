...
// wLancesRoomSceneID
enum {
	SCENE_LANCESROOM_APPROACH_LANCE, // 1
};

// wElmsLabSceneID
enum {
	SCENE_ELMSLAB_CANT_LEAVE,            // 1
...
// wRoute32SceneID
enum {
	SCENE_ROUTE32_OFFER_SLOWPOKETAIL, // 1
...
enum {
	SCENE_BURNEDTOWER1F_RIVAL_BATTLE, // 1
	SCENE_BURNEDTOWER1F_NOTHING,      // 2
};

// wRadioTower5FSceneID
enum {
	SCENE_RADIOTOWER5F_ROCKET_BOSS, // 1
...
enum {
	SCENE_TEAMROCKETBASEB2F_ROCKET_BOSS, // 1
...
enum {
	SCENE_TEAMROCKETBASEB3F_RIVAL_ENCOUNTER, // 1
...
// wOlivinePortSceneID
enum {
	SCENE_OLIVINEPORT_LEAVE_SHIP, // 1
};
